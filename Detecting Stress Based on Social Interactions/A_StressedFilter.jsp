  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	    ...
	    <h2>All Stressed Tweets Details         </h2>
	...
	<table width="572" border="1">
				  <tr>
				    <td colspan="5" ><h2>stressed Tweets of : <%=s1%> [tweet owner: <a href="A_UserProfile.jsp?value=<%=s7%>&type=<%="stressed"%>"> <%=s7%>] </a> </h2></td>
			      </tr>
				  <tr>
					...
					while ( rs1.next() )
			             ...
			             String t2=rs1.getString(2).toLowerCase();
			                 ...
			                 count1++;
									 %>
							  <tr>
								<td width="174" height="0"  style="color:#000000;"><div align="center"><a href="A_UserProfile.jsp?value=<%=s3%>&type=<%="stressed"%>"> <%=s3%></a></div></td>
