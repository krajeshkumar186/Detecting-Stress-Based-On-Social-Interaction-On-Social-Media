  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        ...
        <p class="style3">2. <a href="A_ViewNegResults.jsp">View Negative Emotion Analysis</a></p>
        <p class="style3">3. <a href="A_ViewStressResults.jsp">View Stressed Emotion Analysis</a></p>
        <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
